    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText inputTxt = (EditText) findViewById(R.id.server);
                String typedText = inputTxt.getText().toString();
                serverUri = typedText;
                TextView connTxt = (TextView) findViewById(R.id.conn);
                connTxt.setBackgroundColor(Color.BLUE);
                connTxt.setBackgroundResource(R.drawable.connected);
            }
        });
